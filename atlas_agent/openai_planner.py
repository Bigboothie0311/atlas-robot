...
class OpenAIPlanGenerator:
    ...
    def _instructions(
        ...
        return (
            ...
            "numbering begins at 1. Finding and retrieving "
            "a Windows file normally requires an online "
            "check, file search, and verified download. "
            "The local validated planner remains "
