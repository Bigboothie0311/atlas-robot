...
REGISTRY = [
    ...
    {"id": "shopping_list", "name": "shopping list", "description": "adds, removes, reads back, or clears a shopping/grocery list",
     "aliases": ["add milk to my shopping list", "what's on my shopping list", "remove milk from my shopping list"], "confirm": False, "requires": "none", "category": "everyday"},
    {"id": "chance", "name": "coin flip & dice", "description": "flips a coin or rolls dice",
     "aliases": ["flip a coin", "roll a die", "roll two dice"], "confirm": False, "requires": "none", "category": "everyday"},
    {"id": "unit_convert", "name": "unit conversion", "description": "converts between temperature, distance, and weight units",
     "aliases": ["convert 10 miles to kilometers", "what's 100 fahrenheit in celsius"], "confirm": False, "requires": "none", "category": "everyday"},
    {"id": "countdown", "name": "countdown", "description": "counts down the days until a holiday or date",
     "aliases": ["how many days until christmas", "how many days until march 5th"], "confirm": False, "requires": "none", "category": "everyday"},
    ...
    {"id": "status_report", "name": "status report", "description": "a full cinematic system + security readout",
     "aliases": ["status report", "sitrep"], "confirm": False, "requires": "none", "category": "diagnostics"},
    ...
    {"id": "open_fusion", "name": "Fusion 360", "description": "opens or focuses Fusion 360 on the PC",
     "aliases": ["open Fusion"], "confirm": False, "requires": "pc", "category": "pc"},
    {"id": "open_spotify", "name": "Spotify", "description": "opens or focuses Spotify on the PC",
     "aliases": ["open Spotify"], "confirm": False, "requires": "pc", "category": "pc"},
    {"id": "open_claude", "name": "Claude", "description": "opens or focuses Claude on the PC",
     "aliases": ["open Claude"], "confirm": False, "requires": "pc", "category": "pc"},
    {"id": "open_codex", "name": "Codex", "description": "opens Codex on the PC",
     "aliases": ["open Codex"], "confirm": False, "requires": "pc", "category": "pc"},
    {"id": "open_terminal", "name": "terminal", "description": "opens Windows Terminal / PowerShell on the PC",
     "aliases": ["open terminal", "open powershell"], "confirm": False, "requires": "pc", "category": "pc"},
    {"id": "open_browser", "name": "browser", "description": "opens the browser on the PC",
     "aliases": ["open my browser", "open chrome"], "confirm": False, "requires": "pc", "category": "pc"},
    {"id": "active_window", "name": "active window", "description": "reports which window is currently focused on the PC",
     "aliases": ["what's focused on my PC"], "confirm": False, "requires": "pc", "category": "pc"},
